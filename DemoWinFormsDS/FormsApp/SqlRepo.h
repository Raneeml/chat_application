...
namespace DBRepository {
	...
	public:
		...
		// returns true if table created, false if failed
		// for composite key : separate the column names by comma
		// autoIncrementId : the primary key column which will be auto generated
		// should be defined the first member in its class
		bool createTable(String^ keyColumnNames, bool autoIncrementId);
